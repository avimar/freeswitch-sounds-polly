...
,{filename: 'instructions-for-recording', phrase:'After entering your 7 digit class number, if recordings are available you will be asked to enter the recording number and #. The recordings start at number 1 and go up at each recording, 2 then 3, etc.. During a playback, you have these controls: Press 0 to pause or unpause. Press 1 to rewind 30 seconds or 3 to fast-forward 30 seconds. Press 4 to rewind 5 minutes or press 6 to fast-forward 5 minutes. Press star to end the playback and return to the menu.'}
];